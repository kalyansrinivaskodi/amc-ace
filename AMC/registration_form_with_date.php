...
<body>
  ...
  <div class="container-wrap clearfix">
    <div class="container-page center-page">
      <form class=" form-horizontal form-page" action="register_with_date.php" onsubmit="return validateFormOnSubmit()" method="post" name="form1" id="contact_form" >
      <fieldset>
        <!-- Form Name -->
  ...
  <!-- Text input-->
  <div class="form-group">
    <label class="col-md-4 control-label">AMC Complaint Registration date and time</label>  
      <div class="col-md-4 inputGroupContainer">
      <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-envelope"></i></span>
        <input type="datetime-local" name="in_dt" placeholder="in date and time" id="in_dt" class="form-control">
      </div>
    </div>
  </div>
