...
echo "<a  href='logout.php'>Logout</a>";
	...
	$sql="SELECT Recieved_by, Remarks, LogNo, in_dt FROM usercomplaint WHERE id='$myId'";
...
<body>
  <body>
	...
	<br>
			...
			<hr>
			<form method="POST" action="pending_status_changed_with_date.php" class="status-form">
                    ...
                    echo "<div class='form-group'>";
					echo "<label class='col-md-6 control-label'>Closing Date</label>"; 
					echo "<div class='col-md-6 inputGroupContainer'>";
					echo "<div class='input-group'>";
					echo "<input type='datetime-local' class='login-field' name='at_dt' value ='".$emp['in_dt']."'
					placeholder='Date of closing'  required>";
					echo "</div></div></div>";
