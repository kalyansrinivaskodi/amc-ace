...
$sql ="INSERT INTO usercomplaint (name,designation,dept_name,email,phone,complaintcategory,complaint,in_dt,status) 
VALUES ('$name','$designation','$department','$email','$phone','$compcat','$complaint',now(),'pending')";
