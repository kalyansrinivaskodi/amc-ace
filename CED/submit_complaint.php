...
$stmt = $conn->prepare("INSERT INTO usercomplaintsced (name, designation, department, dorq, department_or_qtr_no,quartertype, phone, internalno, email, description) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
